 ...
 */
public class listarFornecedorBancoDAO {
    ...
    public List<Fornecedor> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT * FROM BANCOS_CONTAS "
                    ...
                    + "WHERE BANCOS_CONTAS.IdBanco='" + jCodigoPesq.getText() + "'");
            ...
            Logger.getLogger(listarFornecedorBancoDAO.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
