...
public class ClientesDAO {
    ...
    public Fornecedor incluirCliente(Fornecedor objForn) {
    ...
    public Fornecedor excluirCliente(Fornecedor objForn) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM CLIENTES WHERE IdClie='" + objForn.getIdForn() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
