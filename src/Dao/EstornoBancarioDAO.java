 ...
 */
public class EstornoBancarioDAO {
    ...
    public MovimentoBancario incluirMovimentoBancos(MovimentoBancario objMovBanc) {
        ...
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO ESTORNO_BANCARIO (StatusEstorno,IdBanco,DataEstorno,TipoPessoa,Depositante,ValorEstorno,TipoEstorno,Observacao,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
