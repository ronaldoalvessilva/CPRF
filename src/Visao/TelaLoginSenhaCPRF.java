...
public class TelaLoginSenhaCPRF extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public TelaLoginSenhaCPRF(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jBtCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/shutdown-icone-6920-32.png"))); // NOI18N
        ...
        jBtAcessar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/ok-icon32.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/User_login_Icon_64.png"))); // NOI18N
        ...
        jLabel5.setText("CPRF - Controle de Contas a Pagar e Receber");
        ...
        jNumeroVersao.setText("1.0");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 153, 0));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Contas a Pagar, Contas a Receber e Fluxo de Caixa");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/cash-coins-currency-icone-6228-64.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Banco248.png"))); // NOI18N
    ...
    private void jBtAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAcessarActionPerformed
        ...
        if (jLogin.getText().equals("")) {
            ...
            try {
                ...
                Logger.getLogger(TelaLoginSenhaCPRF.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLoginSenhaCPRF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaLoginSenhaCPRF dialog = new TelaLoginSenhaCPRF(new javax.swing.JFrame(), true);
    ...
    public void formatarCampos() {
        jLogin.setDocument(new LimiteDigitosMin(21));
