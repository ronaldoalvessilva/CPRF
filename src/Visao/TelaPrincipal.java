...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private TelaFluxoCaixa objFluxo = null;
    //
    ...
    public static String telaFluxoCaixa = "Movimentação:Consulta:Fluxo de Caixa";
    //
    ...
    private void initComponents() {
        ...
        jRelatorioContasPagar = new javax.swing.JMenuItem();
        jSeparator1 = new javax.swing.JPopupMenu.Separator();
        jRelatorioContasRecebidas = new javax.swing.JMenuItem();
        jRelatorioContasPagas = new javax.swing.JMenuItem();
        ...
        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/money_add.png"))); // NOI18N
        jMenu1.setText("Movimento Bancário");

        jDepositoSaques.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.CTRL_MASK));
        jDepositoSaques.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/money_add.png"))); // NOI18N
        jDepositoSaques.setMnemonic('M');
        jDepositoSaques.setText("Depósito/Saque");
        jDepositoSaques.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jDepositoSaquesActionPerformed(evt);
            }
        });
        ...
        listagemChamadosSuporteTecnico.setText("Contas a Receber");
        ...
        jRelatorioContasPagar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/240119193225_16.png"))); // NOI18N
        jRelatorioContasPagar.setText("Contas a Pagar");
        jRelatorioContasPagar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRelatorioContasPagarActionPerformed(evt);
            }
        });
        jRelatorios.add(jRelatorioContasPagar);
        jRelatorios.add(jSeparator1);

        jRelatorioContasRecebidas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/printer.png"))); // NOI18N
        jRelatorioContasRecebidas.setText("Contas Recebidas");
        jRelatorioContasRecebidas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRelatorioContasRecebidasActionPerformed(evt);
            }
        });
        jRelatorios.add(jRelatorioContasRecebidas);

        jRelatorioContasPagas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/printer_empty.png"))); // NOI18N
        jRelatorioContasPagas.setText("Contas Pagas");
        jRelatorioContasPagas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRelatorioContasPagasActionPerformed(evt);
            }
        });
        jRelatorios.add(jRelatorioContasPagas);
...
//        }
    ...
    private void jDepositoSaquesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDepositoSaquesActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaDepartamentos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || codigoUser == codUserAcesso && nomeTela.equals(telaDepartamentos) && codAbrir == 1) {
            if (objMovbanc == null || objMovbanc.isClosed()) {
                objMovbanc = new TelaMovimentoBancario();
                TelaPrincipal.jPainelPrincipal.add(objMovbanc);
                objMovbanc.setVisible(true);
            } else {
                if (objMovbanc.isVisible()) {
                    if (objMovbanc.isIcon()) { // Se esta minimizado
                        try {
                            objMovbanc.setIcon(false); // maximiniza
                        } catch (PropertyVetoException ex) {
                        }
                    } else {
                        objMovbanc.toFront(); // traz para frente
                        objMovbanc.pack();//volta frame 
                    }
                } else {
                    objMovbanc = new TelaMovimentoBancario();
                    TelaPrincipal.jPainelPrincipal.add(objMovbanc);//adicona frame ao JDesktopPane  
                    objMovbanc.setVisible(true);
                }
            }
            try {
                objMovbanc.setSelected(true);
            } catch (java.beans.PropertyVetoException e) {
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Usuário não tem acesso ao registro.");
        }
    }//GEN-LAST:event_jDepositoSaquesActionPerformed

    private void jEstornosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEstornosActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoBancariaEstorno);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || codigoUser == codUserAcesso && nomeTela.equals(telaMovimentacaoBancariaEstorno) && codAbrir == 1) {
            if (objEstorno == null || objEstorno.isClosed()) {
                objEstorno = new TelaMovimentoEstornoBancario();
                TelaPrincipal.jPainelPrincipal.add(objEstorno);
                objEstorno.setVisible(true);
            } else {
                if (objEstorno.isVisible()) {
                    if (objEstorno.isIcon()) { // Se esta minimizado
                        try {
                            objEstorno.setIcon(false); // maximiniza
                        } catch (PropertyVetoException ex) {
                        }
                    } else {
                        objEstorno.toFront(); // traz para frente
                        objEstorno.pack();//volta frame 
                    }
                } else {
                    objEstorno = new TelaMovimentoEstornoBancario();
                    TelaPrincipal.jPainelPrincipal.add(objEstorno);//adicona frame ao JDesktopPane  
                    objEstorno.setVisible(true);
                }
            }
            try {
                objEstorno.setSelected(true);
            } catch (java.beans.PropertyVetoException e) {
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Usuário não tem acesso ao registro.");
    ...
    private javax.swing.JMenuItem jEstornos;
    ...
    private javax.swing.JMenuItem jRelatorioContasPagar;
    private javax.swing.JMenuItem jRelatorioContasPagas;
    private javax.swing.JMenuItem jRelatorioContasRecebidas;
    ...
    public void pesquisarTelasAcessos() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM TELAS "
                    + "WHERE NomeTela='" + telaMovimentoBancario + "'");
            conecta.rs.first();
            pNomeMB = conecta.rs.getString("NomeTela");
        } catch (SQLException ex) {
        }
        try {
            conecta.executaSQL("SELECT * FROM TELAS "
                    + "WHERE NomeTela='" + telaMovimentacaoBancariaEstorno + "'");
            conecta.rs.first();
        ...
        try {
            conecta.executaSQL("SELECT * FROM TELAS "
                    + "WHERE NomeTela='" + telaFluxoCaixa + "'");
            conecta.rs.first();
            pNomeFLUX = conecta.rs.getString("NomeTela");
        } catch (SQLException ex) {
        }
        // CADASTRO
        ...
        if (!pNomeMB.equals(telaMovimentoBancario) || pNomeMB == null || pNomeMB.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
            objCadastroTela.setNomeTela(telaMovimentoBancario);
            controle.incluirTelaAcesso(objCadastroTela);
        }
        if (!pNomeMBE.equals(telaMovimentacaoBancariaEstorno) || pNomeMBE == null || pNomeMBE.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
        ...
        if (!pNomeFLUX.equals(telaFluxoCaixa) || pNomeFLUX == null || pNomeFLUX.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
            objCadastroTela.setNomeTela(telaFluxoCaixa);
            controle.incluirTelaAcesso(objCadastroTela);
        }
    }
