...
import static Visao.TelaCentroCusto.jCodigo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaCC extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM CENTRO_CUSTO WHERE IdCentro='" + jCodigo.getText() + "'");
            conecta.rs.first();
