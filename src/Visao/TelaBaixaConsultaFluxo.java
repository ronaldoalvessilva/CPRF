...
import static Visao.TelaFluxoCaixa.idLancFluxo;
import static Visao.TelaFluxoCaixa.pOPERACAO_CONTAS_PR;
 ...
 * @author ronal
 */
public class TelaBaixaConsultaFluxo extends javax.swing.JDialog {
     ...
     */
    public static TelaFluxoCaixa pMOVI_CONTAS_PR_CONSULTA;

    public TelaBaixaConsultaFluxo(TelaFluxoCaixa parent, boolean modal) {
        ...
        corCampos();
        verificarBaixa();
        if (idLancFluxo.equals(pCODIGO_MOV_BAIXA)) {
            mostrarBaixa();
            Confirmar();
        }
    }
    ...
    private void jBtCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtCalcularActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TelaBaixaConsultaFluxo.class.getName()).log(Level.SEVERE, null, ex);
        }
        objBaixa.setDiasAtraso(Integer.valueOf(jDiasAtraso.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBaixaConsultaFluxo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBaixaConsultaFluxo dialog = new TelaBaixaConsultaFluxo(pMOVI_CONTAS_PR_CONSULTA, true);
        ...
        if (pOPERACAO_CONTAS_PR.equals("Pagar")) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM BAIXA_CONTAS_PAGAR_RECEBER "
                        ...
                        + "WHERE BAIXA_CONTAS_PAGAR_RECEBER.IdMov='" + idLancFluxo + "'");
                conecta.rs.first();
