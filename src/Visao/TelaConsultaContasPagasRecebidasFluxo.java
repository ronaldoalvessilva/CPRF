 ...
 * @author ronal
 */
public class TelaConsultaContasPagasRecebidasFluxo extends javax.swing.JDialog {
     ...
     */
    public static TelaFluxoCaixa pCONSULTAS_CONTAS_PAGAS_RECEBIDAS;

    public TelaConsultaContasPagasRecebidasFluxo(TelaFluxoCaixa parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaContasPagasRecebidasFluxo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaContasPagasRecebidasFluxo dialog = new TelaConsultaContasPagasRecebidasFluxo(pCONSULTAS_CONTAS_PAGAS_RECEBIDAS, true);
        ...
        if (pOPERACAO_CONTAS_PR.equals("Pagar")) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM MOVIMENTO_CONTAS_PAGAR_RECEBER "
                        + "WHERE MOVIMENTO_CONTAS_PAGAR_RECEBER.IdMov='" + idLancFluxo + "' "
            ...
            try {
                ...
                Logger.getLogger(TelaConsultaContasPagasRecebidasFluxo.class.getName()).log(Level.SEVERE, null, ex);
            }
