...
import static Visao.TelaTipoContas.jCodigo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTC extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TIPO_CONTA WHERE IdConta='" + jCodigo.getText() + "'");
            conecta.rs.first();
